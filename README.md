...
This is a simple application to fetch github repositories based on github API. I coded this project to practice my knowledge of HTML, CSS, JavaScript, JSON, and AJAX in a real project.
